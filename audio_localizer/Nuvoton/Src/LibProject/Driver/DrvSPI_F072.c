...
#if (__CHIP_SERIES__==__N572F072_SERIES__)
//--------------------------------------------------------------------------------------------------------------
...
)
{
	...
	((SPI_T*)u32SpiHandler)->CNTRL.u32Reg = u32OpenFlag|SPI_CNTRL_IF;		// Clear interrupt flag for 072 name is SPIIF
...
)
{
	...
	((SPI_T*)u32SpiHandler)->CNTRL.u32Reg = (((SPI_T*)u32SpiHandler)->CNTRL.u32Reg & (~SPI_CNTRL_IF)) | SPI_CNTRL_IE; //for 072 name is SPIIF, SPIIE
...
#endif // __CHIP_SERIES__==__N572F065_SERIES__
